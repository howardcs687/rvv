    ...
    <div className="space-y-4">
      <div className="flex items-center gap-4 pb-4 border-b-2 border-gray-200">
        <img 
          ...
          src="/pictures/howardPicture.webp" 
          alt="Howard Profile"
        />
        <div>
          <h2 className="text-2xl font-bold text-gray-800">Howard Ramos</h2>
          <p className="text-orange-600 font-semibold">VPN kaba? Kasi secured ka sa puso ko</p>
        </div>
      </div>
      ...
      <div>
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <span className="px-3 py-1 bg-blue-100 text-blue-800 rounded-full text-xs font-semibold">JavaScript</span>
      ...
      <div>
        ...
        <div className="flex flex-wrap gap-2">
          <a href="https://www.facebook.com/rhowardking/" className="px-3 py-2 bg-gray-800 text-white rounded text-xs font-semibold hover:bg-gray-700">
            F Facebook
          </a>
          <a href="mailto:102903090039@r2.deped.gov.ph" className="px-3 py-2 bg-orange-500 text-white rounded text-xs font-semibold hover:bg-orange-600">
            📧 Email
          </a>
        </div>
      </div>
