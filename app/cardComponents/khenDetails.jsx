  ...
  return (
    <div className="space-y-4">
      ...
      <div>
        ...
        <div className="flex flex-wrap gap-2">
          <a href="https://www.facebook.com/rmskhen" className="px-3 py-2 bg-gray-800 text-white rounded text-xs font-semibold hover:bg-gray-700">
            F Facebook
          </a>
          <a href="mailto:ramoskhen@gmail.com" className="px-3 py-2 bg-orange-500 text-white rounded text-xs font-semibold hover:bg-orange-600">
            📧 Email
          </a>
        </div>
      </div>
